...
For frontend experiments there’s a simple ES module at
...
.Returns: `false\|string` — The original value when alphabetic; otherwise, `false`.
...
.Returns: `mixed` — The original value when it contains only decimal digits; otherwise, `false`.
...
.Returns: `mixed` — The original value when it contains only hexadecimal digits; otherwise, `false`.
...
.Returns: `false\|string` — The original value when alphanumeric; otherwise, `false`.
