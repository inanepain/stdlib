...
$merged = Merge::mergeOptionsWithUpdateOnly($defaults, $env);
/* Result:
[
  'host' => 'localhost',
  'port' => 3307,
...
$added = Merge::mergeOptionsWithAddOnly($defaults, ['timeout' => 5]);
// 'timeout' is appended, existing values untouched

// Add and update (full overlay)
$overlay = Merge::mergeOptionsWithAddAndUpdate($defaults, $env);
