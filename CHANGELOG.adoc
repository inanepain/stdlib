...
* update: `Json` The `encode` & `decode` methods new options key *onerror*. This lets you set if an error should be *thrown* and if *UTF8* characters should be either *ignored* or *substituted* in the response.
